...
admin_router.post('/productsAdd',upload.array('images',3),productController.addProducts)
...
admin_router.post('/productedit/:id',upload.fields([{ name: 'image0', maxCount: 1 }, { name: 'image1', maxCount: 1 }, { name: 'image2', maxCount: 1 }]),productController.editProduct)
admin_router.get('/products',productController.loadProducts)
admin_router.get('/products',productController.loadProducts)
